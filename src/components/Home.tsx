...
import { sampleData, type TextItem, getUniqueGenres, getUniqueTypes } from '../utils/sampleData';
...
const Home = () => {
  ...
  return (
    <div className="relative w-full h-screen">
      ...
      <div className="absolute top-0 left-0 w-full z-20 pt-6 pb-4 text-center bg-gradient-to-b from-black/90 to-black/0">
        <div className="inline-block px-8 py-4 rounded-lg bg-black/60 backdrop-blur-lg border border-purple-500/30 shadow-lg">
          <h1 className="text-4xl font-bold bg-gradient-to-br from-purple-300 via-pink-300 to-indigo-400 bg-clip-text text-transparent drop-shadow-sm">
            Asian American Studies Literature Visualization
          </h1>
          <p className="text-gray-300 text-sm mt-2">
            Explore relationships between embeddings in 3D vector space
          </p>
        </div>
      </div>
      ...
      <div className="absolute bottom-4 right-4 bg-black/70 p-3 rounded-md text-white text-xs z-10 backdrop-blur-sm border border-white/10">
        <p className="mb-1"><span className="font-bold">Click on a node</span> to see details</p>
